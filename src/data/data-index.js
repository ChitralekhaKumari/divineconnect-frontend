...
export const testimonialsData = [
  { id: 1, name: 'Priya Sharma', location: 'Mumbai', avatar: 'PS', rating: 5, text: 'The temple directory is beautifully done. I found detailed information and live darshan for temples I have wanted to visit for years, right from my home in Mumbai.' },
  { id: 2, name: 'Rajesh Iyer', location: 'Bangalore', avatar: 'RI', rating: 5, text: 'I start every morning with the bhajans and daily prayers on DivineConnect. The scripture library with meanings alongside the Sanskrit verses has deepened my understanding so much.' },
  { id: 3, name: 'Ananya Gupta', location: 'Delhi', avatar: 'AG', rating: 5, text: 'The Hindu calendar keeps our whole family on top of every festival and auspicious tithi. Combined with the astrology consultations, it feels like a complete spiritual companion.' },
];
